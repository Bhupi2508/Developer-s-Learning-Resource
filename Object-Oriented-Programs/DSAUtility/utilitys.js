...
module.exports = {
    ...
    */
    ...
    unOrderedList(word) {
        try {
            ...
            var data = linkList.fileCall('H:/Programming Codes/Object-Oriented-Programs/file.txt')
            ...
            */
            var display = linkList.display();
            linkList.writeFile('H:/Programming Codes/Object-Oriented-Programs/file.txt', display)
        }
        catch (error) {
            console.error(error);
        }
    ...
    */
    ...
    orderedList(number) {
        try {
            var linkList = new util.LinkedList();
            var data1 = linkList.fileCall('H:/Programming Codes/Object-Oriented-Programs/file1.txt', 'utf8')
            var data = [];
            ...
            */
            ...
            after apply condition print the final file
            */
            linkList.writeFile('H:/Programming Codes/Object-Oriented-Programs/file1.txt', display)
        }
        catch (error) {
            console.error(error);
        }
